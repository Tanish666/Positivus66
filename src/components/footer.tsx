...
function Footer() {
  return (
    <motion.footer className="relative text-gray-200 pb-0 pt-16 overflow-hide bg-zinc-950 border-t-[1px] border-zinc-500 rounded-t-[3rem] z-[9999999999]">
      <motion.div className="w-full px-10 mx-auto flex flex-col md:flex-row md:justify-center gap-10 md:gap-12 pb-10">
        ...
        <div className="flex-1 min-w-[220px] ml-0 md:ml-8">
          <div className="flex items-center gap-2 mb-2">
            <img src="/fulllogo.svg" alt="codemate Logo" className="w-50 h-10" />
          </div>
          <p className="text-gray-400 mb-4 text-sm md:text-lg w-full md:w-1/2">
          ScaffoldGen, your smart project scaffolding partner.
          Generate clean, production-ready project structures in seconds with a powerful, developer-first CLI.
          </p>

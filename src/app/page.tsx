...
<div className='absolute bottom-10'>
  ...
  <motion.img initial={{scale:1,y:100}} src="gl.png" alt=""  className="absolute hidden lg:flex  "/>
...
<div className='lg:text-5xl  flex flex-col gap-1 font-semibold mt-20 opacity-70'>
